1. Каков размер MBR из чего он состоит?
  - Занимает 512 байт. Состоит из кода загрузчика, таблицы разделов и сигнатуры.
2. Сколько разделов поддерживает MBR
  - MBR поддерживает до 4 разделов (если не учитывать возможность назначения раздела расширенным и создания на нем подразделов).
